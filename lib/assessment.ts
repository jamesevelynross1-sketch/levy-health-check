            ...
            recommendations: [
              {
                ...
                detail: 'Map critical roles, skill gaps and recruitment challenges to apprenticeship standards to create a structured pipeline.',
                priority: 'High',
              },
              {
                title: 'Establish apprenticeship ownership',
                detail: 'Assign responsibility for apprenticeship planning within HR or L&D to ensure alignment with workforce demand.',
                priority: 'High',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Introduce cross-functional workforce planning sessions to align apprenticeship use with operational and strategic priorities.',
                priority: 'Medium',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Introduce forward-looking workforce modelling to improve timing and scale of apprenticeship starts.',
                priority: 'Low',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Create a monthly levy dashboard showing contributions, spend, expiry risk and forecast utilisation.',
                priority: 'High',
              },
              {
                title: 'Identify immediate deployment opportunities',
                detail: 'Map current workforce roles to apprenticeship standards to quickly absorb unused levy.',
                priority: 'High',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Move from tracking to active planning by linking levy spend to workforce demand and business priorities.',
                priority: 'Medium',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Refine timing, transfers and reserve usage to maximise financial return.',
                priority: 'Low',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Define clear pathways from application to completion to improve tracking and scalability.',
                priority: 'High',
              },
              {
                title: 'Introduce outcome reporting',
                detail: 'Track completion rates, progression and ROI to improve programme effectiveness.',
                priority: 'High',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Implement consistent onboarding, tracking and reporting across all apprenticeship programmes.',
                priority: 'Medium',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Expand successful apprenticeship pathways into additional roles or departments.',
                priority: 'Low',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Create a formal governance forum with clear accountability for levy decisions and performance.',
                priority: 'High',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Define ownership across HR, finance and operational teams for levy performance.',
                priority: 'Medium',
              },
            ],
          },
            ...
            recommendations: [
              {
                ...
                detail: 'Introduce more frequent and data-driven governance reviews to improve outcomes.',
                priority: 'Low',
              },
            ],
          },
